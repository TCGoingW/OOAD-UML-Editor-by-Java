...
import Object.*;
import Object.Line.GeneralizationLine;
...
public class GeneralizationLineMode extends Mode{
    ...
    public GeneralizationLineMode(MyGraphic gg) {
        super(gg);
    }
    ...
    public void mouseReleasedAction(Point currentPoint) {
        ...
        if(startPort != null && endPort != null)
            super.graphicsInCanvas.addGraphic(new GeneralizationLine(startPort, endPort));
    }
}
